export default function CricketField({ teamFormat = 11 }) {
  return (
    <div className="absolute inset-[3%] pointer-events-none">
      ...
      {teamFormat >= 11 && (
        <>
          <span className="absolute top-[6%] left-1/2 -translate-x-1/2 text-[8px] text-white/40 font-medium tracking-wide">FINE LEG</span>
          <span className="absolute top-[6%] right-[10%] text-[8px] text-white/40 font-medium tracking-wide">THIRD MAN</span>
          <span className="absolute bottom-[6%] left-1/2 -translate-x-1/2 text-[8px] text-white/40 font-medium tracking-wide">LONG ON</span>
          <span className="absolute top-1/2 left-[4%] -translate-y-1/2 text-[8px] text-white/40 font-medium tracking-wide" style={{ writingMode: 'vertical-rl' }}>MID WICKET</span>
          <span className="absolute top-1/2 right-[4%] -translate-y-1/2 text-[8px] text-white/40 font-medium tracking-wide" style={{ writingMode: 'vertical-rl' }}>COVER</span>
        </>
      )}
    </div>
  )
