            ...
            <div className="bg-gradient-to-r from-blue-600 to-blue-500 px-4 py-3 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center">
                  {tab === 'chat' ? <BookOpen className="w-4 h-4 text-primary" /> : <Ticket className="w-4 h-4 text-primary" />}
                </div>
                <div>
                  <p className="text-primary font-medium text-sm">{tab === 'chat' ? 'App Guide' : 'Submit a Ticket'}</p>
                  <p className="text-primary/70 text-xs">{tab === 'chat' ? 'Learn how to use MoonBoots Sports' : 'Get help from our team'}</p>
                </div>
              </div>
                ...
                {submitted ? (
                  <div className="p-6 text-center">
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-subtle hover:bg-border-default text-primary rounded-lg text-sm transition-colors"
                    >
                      Back to App Guide
                    </button>
                  </div>
