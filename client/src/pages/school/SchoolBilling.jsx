  ...
  return (
    <div className="p-4 sm:p-6 max-w-5xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-secondary text-sm mt-1">Manage your school's MoonBoots Sports subscription</p>
      </div>
          ...
          <div className="flex items-start justify-between flex-wrap gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-subtle hover:bg-border-default border border-border-strong text-primary rounded-lg text-sm transition-colors"
              >
                {portalLoading ? (
          ...
          return (
            ...
            >
              ...
              <div className="mb-4">
                ...
                <p className="text-sm text-secondary mt-1">Up to {plan.teamLimit} teams</p>
              </div>
              ...
              {isCurrent ? (
                <button
                  disabled
                  className="w-full py-2.5 rounded-lg text-sm font-medium bg-subtle text-secondary border border-border-strong cursor-default"
                >
                  Current Plan
                </button>
              ) : (
      ...
      {/* FAQ / Info */}
      <section className="bg-card border border-border-default rounded-xl p-5">
        <h2 className="text-lg font-semibold text-primary mb-3">Frequently Asked Questions</h2>
        <div className="space-y-4 text-sm">
          <div>
            <p className="text-primary font-medium">Can I change plans later?</p>
            <p className="text-secondary mt-1">Yes, you can upgrade or downgrade at any time. Changes take effect immediately and billing is prorated.</p>
          </div>
          <div>
            <p className="text-primary font-medium">What payment methods are accepted?</p>
            <p className="text-secondary mt-1">We accept all major credit and debit cards via Stripe. All payments are secure and PCI compliant.</p>
          </div>
          <div>
            <p className="text-primary font-medium">Can I cancel at any time?</p>
            <p className="text-secondary mt-1">Yes, you can cancel your subscription at any time from the billing portal. You'll retain access until the end of your billing period.</p>
          </div>
        </div>
      </section>
    </div>
