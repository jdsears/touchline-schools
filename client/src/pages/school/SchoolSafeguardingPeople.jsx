...
export default function ClubSafeguardingPeople() {
  ...
  async function handleAdd(e) {
    ...
    setSaving(true)
    try {
      await clubSafeguardingService.createComplianceRecord(school.id, form)
  ...
  async function handleUpdate(recordId) {
    setSaving(true)
    try {
      await clubSafeguardingService.updateComplianceRecord(school.id, recordId, editForm)
  ...
  async function handleUpload(recordId, file) {
    ...
    try {
      await clubSafeguardingService.uploadDocument(school.id, recordId, formData)
