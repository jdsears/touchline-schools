...
export default function ClubBilling() {
  ...
  async function loadSubscription() {
    try {
      // Club subscriptions are tied to the first team linked to the club
      // We need to check the club's subscription_tier and subscription_status
      setSubscription({
  ...
  return (
    <div className="p-4 sm:p-6 max-w-5xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-navy-400 text-sm mt-1">Manage your club's Touchline subscription</p>
      </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-navy-400 mt-1">
                Subscribe to a club plan to unlock payment collection, advanced features, and manage multiple teams.
              </p>
            </div>
          </div>
        </section>
