...
export default function CreateClub() {
  ...
  async function handleSubmit(e) {
    e.preventDefault()
    if (!dpaAccepted) {
      toast.error('You must accept the Data Processing Agreement to create a club.')
      return
    }
    setSaving(true)
    try {
    ...
    <div className="p-4 sm:p-6 max-w-2xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-navy-400 text-sm">
          Set up your club to manage multiple teams, players, guardians, and payments from one place.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <section className="bg-navy-900 border border-navy-800 rounded-xl p-5 space-y-4">
          <div>
            <label className="block text-xs text-navy-400 mb-1">Club Name *</label>
            <input
        ...
        <section className="bg-navy-900 border border-navy-800 rounded-xl p-5 space-y-4">
          ...
          {showDpa && (
            <div className="bg-navy-800/50 rounded-lg p-4 text-xs text-navy-300 space-y-3 max-h-80 overflow-y-auto border border-navy-700">
              ...
              <p>The Club acts as the <strong className="text-navy-200">Data Controller</strong> under UK GDPR. The Club determines what personal data is collected, the purpose of collection, and is responsible for ensuring lawful basis for processing. Touchline acts as a <strong className="text-navy-200">Data Processor</strong>, processing data solely on the Club's instructions through the platform.</p>

              <h4 className="font-medium text-navy-200">2. Data Processed</h4>
              <p>Personal data processed includes: player names, dates of birth, medical information, emergency contacts, passport-style photographs, identity documents, guardian contact details, payment information (via Stripe), and consent records.</p>
              ...
              <ul className="list-disc pl-4 space-y-1">
                <li>Process data only as instructed by the Club through the platform.</li>
                ...
                <li>Assist the Club in responding to DSARs and breach notifications.</li>
                <li>Delete or return all personal data upon termination of the Club's account (within 30 days).</li>
              ...
              <p>Data is retained while the Club's account is active. Upon account closure, all Club data (including player records, documents, and payment history) is deleted within 30 days. Clubs may request early deletion at any time.</p>
              ...
              <p>In the event of a personal data breach, Touchline will notify the Club without undue delay and no later than 48 hours after becoming aware of the breach.</p>
          ...
          <label className="flex items-start gap-3 cursor-pointer">
            ...
            <span className="text-sm text-navy-300">
              I confirm that I am authorised to act on behalf of this club and I accept the <button type="button" onClick={() => setShowDpa(true)} className="text-amber-400 hover:text-amber-300 underline">Data Processing Agreement</button>. I understand that the club is the Data Controller and is responsible for ensuring lawful basis for processing personal data. *
            </span>
          </label>
        </section>
