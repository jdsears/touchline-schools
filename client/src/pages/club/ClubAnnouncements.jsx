...
export default function ClubAnnouncements() {
  ...
  async function loadData() {
    try {
      const [announcementsRes, teamsRes] = await Promise.all([
        clubCommsService.getAnnouncements(club.id, { include_expired: true }),
  ...
  async function loadCommsLog() {
    try {
      const res = await clubCommsService.getCommsLog(club.id)
  ...
  async function handleCreate(e) {
    ...
    setSaving(true)
    try {
      await clubCommsService.createAnnouncement(club.id, {
        ...form,
  ...
  async function handleBulkEmail(e) {
    ...
    setSending(true)
    try {
      const res = await clubCommsService.sendToParents(club.id, {
        ...emailForm,
  ...
  async function handleDelete(announcementId) {
    ...
    try {
      await clubCommsService.deleteAnnouncement(club.id, announcementId)
  ...
  async function handleTogglePin(announcement) {
    try {
      await clubCommsService.updateAnnouncement(club.id, announcement.id, {
