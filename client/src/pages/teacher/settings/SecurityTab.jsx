  ...
  return (
    <div className="max-w-xl space-y-6">
      <div>
        ...
        <p className="text-sm text-navy-400 mt-1">Password, active sessions, and account security.</p>
      </div>
      ...
      <div className="bg-navy-900 rounded-xl border border-navy-800 p-5">
        <div className="flex items-center justify-between mb-4">
          ...
          {!changingPassword && (
            <button
              ...
              className="px-3 py-1.5 bg-navy-800 hover:bg-navy-700 text-navy-300 rounded-lg text-xs transition-colors"
            >
              Change password
            </button>
          )}
        ...
        {changingPassword ? (
          ...
          <p className="text-xs text-navy-500">Last changed: unknown</p>
        )}
      </div>
      ...
      <div className="bg-navy-900 rounded-xl border border-navy-800 p-5">
        ...
        <p className="text-xs text-navy-500 mb-3">Add an extra layer of security to your account.</p>
        <button
      ...
      <div className="bg-navy-900 rounded-xl border border-navy-800 p-5">
        <div className="flex items-center gap-2 mb-2">
          <Monitor className="w-4 h-4 text-navy-400" />
          <span className="text-sm font-medium text-white">Active Sessions</span>
        </div>
        <div className="flex items-center gap-3 py-2 border border-navy-800 rounded-lg px-3 mt-2">
          <Monitor className="w-4 h-4 text-pitch-400 flex-shrink-0" />
          <div className="flex-1 text-xs text-navy-300">Current session</div>
