...
function Toggle({ checked, onChange }) {
  return (
    <button
      ...
      className={`w-10 h-5 rounded-full transition-colors relative flex-shrink-0 ${checked ? 'bg-pitch-600' : 'bg-navy-700'}`}
    >
  ...
  return (
    <div className="max-w-xl space-y-6">
      <div>
        ...
        <p className="text-sm text-navy-400 mt-1">Adjust the interface to suit your needs.</p>
      </div>
