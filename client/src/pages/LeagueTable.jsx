      ...
      >
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3 p-3 rounded-lg bg-subtle border border-border-strong">
              <input
                type="checkbox"
                id="useEmbed"
              ...
              />
              <label htmlFor="useEmbed" className="text-sm text-secondary">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              <input
                ...
                className="w-4 h-4 rounded border-border-strong"
              />
              <label htmlFor="isOwnTeam" className="text-sm text-secondary">
                This is our team
              </label>
            </div>
              ...
              <>
                ...
                {imagePreview ? (
                  ...
                  >
                    ...
                    <p className="text-sm text-secondary mt-1">PNG, JPG up to 5MB</p>
                    <input
                      ref={fileInputRef}
                      type="file"
                      accept="image/*"
              ...
              <>
                ...
                <div className="overflow-x-auto max-h-96">
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="bg-subtle text-left text-secondary">
                        ...
                        >
                          ...
                          {importType === 'detailed' && (
                            <>
                              ...
                              <td className="px-3 py-2 text-center text-secondary">{teamRow.goals_against}</td>
                            </>
                          )}
        ...
        {['played', 'won', 'drawn', 'lost', 'goals_for', 'goals_against'].map(field => (
          <td key={field} className="px-2 py-3">
            <input
              type="number"
              min="0"
              className="w-12 bg-border-default border border-border-strong rounded px-2 py-1 text-center text-white text-sm"
              value={stats[field]}
  ...
  if (settings?.use_fa_embed && settings?.fa_fulltime_table_url) {
    return (
      <div className="p-6 max-w-5xl mx-auto">
        ...
        <div className="card">
          <div className="flex items-center justify-between mb-4">
            <p className="text-sm text-secondary">Data from FA Full-Time</p>
            <a
    ...
    <div className="p-6 max-w-5xl mx-auto">
      ...
      {sortedTable.length > 0 ? (
          ...
          <div className="overflow-x-auto">
            {viewMode === 'detailed' && hasDetailedStats ? (
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-subtle text-left text-secondary">
                    ...
                    <th className="px-2 py-2 text-center border-l border-border-strong" colSpan={6}>
                    ...
                    <th className="px-2 py-2 text-center border-l border-border-strong" colSpan={4}>Overall</th>
                    {isManager && <th className="px-3 py-3 font-medium" rowSpan={2}></th>}
                  </tr>
                  <tr className="bg-subtle text-xs text-secondary">
                    <th className="px-2 py-2 text-center border-l border-border-strong">P</th>
                    ...
                    <th className="px-2 py-2 text-center">F</th>
                    <th className="px-2 py-2 text-center">A</th>
                    <th className="px-2 py-2 text-center border-l border-border-strong">W</th>
                    <th className="px-2 py-2 text-center">D</th>
                        ...
                        <td className="px-3 py-2">
                          <div className="flex gap-1">
                            <button
                              ...
                              className="p-1 text-secondary hover:text-white hover:bg-border-default rounded"
                            >
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-subtle text-left text-sm text-secondary">
        ...
        <div className="card text-center py-12">
          <TableIcon className="w-12 h-12 mx-auto mb-4 text-tertiary" />
          <p className="text-secondary mb-4">No league table set up yet</p>
          {isManager && (
