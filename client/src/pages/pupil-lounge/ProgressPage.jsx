  ...
  return (
    <div className="bg-navy-900/60 border border-navy-800/50 rounded-xl px-3 py-2.5">
      ...
      {assessment.teacher_notes && (
        <p className="text-[10px] text-secondary mt-1.5 line-clamp-2 leading-relaxed">{assessment.teacher_notes}</p>
      )}
    </div>
  )
}
  ...
  return (
    <div className="mt-5">
      ...
      <div className="space-y-2">
        {achievements.map(a => (
          <div key={a.id} className="bg-navy-900 border border-border-strong rounded-lg px-3 py-2.5 flex items-center gap-2">
